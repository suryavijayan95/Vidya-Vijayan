# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in Newsletter-sub.
...
import newsletter_sub
from newsletter_sub import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': newsletter_sub.model,
    'DBSession': newsletter_sub.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "a6968316-bf03-4124-922a-6ac5ab3d88ef",
